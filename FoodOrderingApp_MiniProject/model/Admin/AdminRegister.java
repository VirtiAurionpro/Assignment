...
public class AdminRegister implements IRegister {
	...
	public List<AdminObject> start(List<AdminObject> adminList) {
		Scanner scanner = new Scanner(System.in);
		System.out.println("Enter your name:");
		String name = scanner.next();
		System.out.println("Enter your age:");
		int age = scanner.nextInt();
		String adminUsername = validateUsername(scanner);
		while (true) {
		...
		adminList.add(new AdminObject(name, age, adminID, adminUsername, adminPassword));
