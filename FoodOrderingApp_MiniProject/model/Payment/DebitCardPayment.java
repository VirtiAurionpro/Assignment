...
public class DebitCardPayment extends basicDetails implements IPayment {
	...
	public DebitCardPayment(int cVV, String accountHolderName, String accountValidity, int oTP, int userOTP) {
		super();
		CVV = cVV;
	...
	public boolean donePayment(double billAmount) {
		if (validate()) {
			System.out.println("Payemnt done of " + billAmount + " using debit card.");
			return true;
		}
		if (!validate())
