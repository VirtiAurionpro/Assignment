					...
					<form action="AddBeneficiaryController" method="post">
						...
						<div class="form-group">
							<input type="text" class="form-control item" id="name"
								name="name" placeholder="Beneficiary Name" required>
						</div>
						...
						<div class="form-group">
							<input type="text" class="form-control item"
								...
								placeholder="Re-Type Account Number" required>
						</div>
						...
						<div class="form-group">
							<input type="text" class="form-control item" id="ifsc"
								name="ifsc" placeholder="Bank IFSC Code" required>
						</div>

						<div class="form-group">
							<input type="text" class="form-control item" id="mobile"
								name="mobile" placeholder="Beneficiary Mobile Number (optional)">
						</div>

						<div class="form-group">
							<input type="email" class="form-control item" id="email"
								name="email" placeholder="Beneficiary Email (optional)">
						</div>

						<div class="form-group">
							<input type="text" class="form-control item" id="nickname"
								name="nickname" placeholder="Beneficiary Nickname (optional)">
						</div>
						<div class="form-group">
